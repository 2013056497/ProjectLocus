...
<!-- Mirrored from thevectorlab.net/flatlab/project_list.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 May 2016 02:09:40 GMT -->
<head>
    <meta charset="utf-8">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="header-color.php">Different Color Top bar</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="project_list.php">Project List</a></li>
          ...
          <section class="wrapper site-min-height">
              ...
              <section class="panel">
                  ...
                  <table class="table table-hover p-table">
                      ...
                      <tr>
                          <td class="p-name">
                              <a href="project_details.php">New Dashboard BS3</a>
                              <br>
                          ...
                          <td>
                              <a href="project_details.php" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a>
                      ...
                      <tr>
                          <td class="p-name">
                              <a href="project_details.php">Creative Portfolio</a>
                              <br>
                      ...
                      <tr>
                          <td class="p-name">
                              <a href="project_details.php">Directory & listing</a>
                              <br>
