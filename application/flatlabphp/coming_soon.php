...
<!-- Mirrored from thevectorlab.net/flatlab/coming_soon.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 May 2016 02:09:35 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="cs-bg">
    ...
    <section id="header">
        <div class="container">
            <header>
                <!-- HEADLINE -->
                <a class="logo floatless" href="index-2.php">Flat<span>lab</span></a>
                <h1 > Coming Soon...</h1>
                <br/>
...
<!-- Mirrored from thevectorlab.net/flatlab/coming_soon.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 May 2016 02:09:36 GMT -->
</html>