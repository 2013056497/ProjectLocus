...
<!-- Mirrored from thevectorlab.net/flatlab/lock_screen.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 May 2016 02:09:37 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="lock-screen" onload="startTime()">
    ...
    <div class="lock-wrapper">
        ...
        <div class="lock-box text-center">
            ...
            <form role="form" class="form-inline" action="http://thevectorlab.net/flatlab/index.php">
