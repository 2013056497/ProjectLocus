...
<!-- Mirrored from thevectorlab.net/flatlab/draggable_portlet.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 May 2016 02:07:12 GMT -->
<head>
    <meta charset="utf-8">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li  class="active"><a  href="draggable_portlet.php">Draggable Portlet</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
