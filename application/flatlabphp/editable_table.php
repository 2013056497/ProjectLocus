...
<!-- Mirrored from thevectorlab.net/flatlab/editable_table.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 May 2016 02:08:23 GMT -->
<head>
    <meta charset="utf-8">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="editable_table.php">Editable Table</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
