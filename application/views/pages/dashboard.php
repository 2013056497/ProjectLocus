              ...
              <section class="panel">
                  <div class="panel-body">
                      <a href="#" class="task-thumb">
                          <img src="<?=base_url()?>img/avatar1.jpg" alt="">
                      </a>
                                  ...
                                  <div class="timeline-desk">
                                      <div class="panel">
                                          <div class="panel-body">
                                              ...
                                              <div class="album">
                                                  <a href="#">
                                                      <img alt="" src="<?=base_url()?>img/sm-img-1.jpg">
                                                  </a>
                                                  <a href="#">
                                                      <img alt="" src="<?=base_url()?>img/sm-img-2.jpg">
                                                  </a>
                                                  <a href="#">
                                                      <img alt="" src="<?=base_url()?>img/sm-img-3.jpg">
                                                  </a>
                                                  <a href="#">
                                                      <img alt="" src="<?=base_url()?>img/sm-img-1.jpg">
                                                  </a>
              ...
              <section class="panel post-wrap pro-box">
                  ...
                  <aside class="post-highlight yellow v-align">
                      <div class="panel-body text-center">
                          <div class="pro-thumb">
                              <img src="<?=base_url()?>img/ring.jpg" alt="">
                          </div>
                      </div>
                  </aside>
              </section>
                          ...
                          <div class="follower">
                              <div class="panel-body">
                                  ...
                                  <div class="follow-ava">
                                      <img src="<?=base_url()?>img/follower-avatar.jpg" alt="">
                                  </div>
                              </div>
                          </div>
