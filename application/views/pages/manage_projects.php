        ...
        <section class="panel">
            ...
            <table class="table table-hover p-table">
                ...
                <tr>
                    ...
                    <td class="p-team">
                        <a href="#"><img alt="image" class="" src="<?=base_url()?>img/chat-avatar.jpg"></a>
                        <a href="#"><img alt="image" class="" src="<?=base_url()?>img/chat-avatar2.jpg"></a>
                        <a href="#"><img alt="image" class="" src="<?=base_url()?>img/pro-ac-1.png"></a>
                    </td>
                    <td class="p-progress">
                ...
                <tr>
                    ...
                    <td class="p-team">
                        ...
                        <a href="#"><img alt="image" class="" src="<?=base_url()?>img/chat-avatar2.jpg"></a>
                        <a href="#"><img alt="image" class="" src="<?=base_url()?>img/pro-ac-1.png"></a>
                        <a href="#"><img alt="image" class="" src="<?=base_url()?>img/pro-ac-2.png"></a>
                    </td>
                    <td class="p-progress">
                        <div class="progress progress-xs">
