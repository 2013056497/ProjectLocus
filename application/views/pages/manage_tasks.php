              ...
              <section class="panel">
                  <header class="panel-heading">
                      ...
                      <span class="pull-right">
                          <button type="button" id="loading-btn" class="_red btn btn-danger btn-xs"><i class="fa fa-refresh"></i> Refresh</button>
                      </span>
                  </header>
              ...
              <div class="row">
                  <div class="col-md-8">
                      <section class="panel">
                          <div class="bio-graph-heading project-heading">
                              <strong> <!-- MUST BE PROJECT TITLE--> Test Project </strong>
                          </div>
                  ...
                  <div class="col-md-4">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <a href="#"><img src="<?=base_url()?>img/email-img/vector-lab.jpg" alt=""/></a>
