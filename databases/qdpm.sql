...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 01, 2016 at 03:32 AM
...
(1, 'app_administrator_email', 'superadmin@locus.com'),
(2, 'app_administrator_password', '$P$EGlpehhkUNijugUQddxrc8boOvG53a.'),
(3, 'app_app_name', 'Testing'),
...
--
-- Table structure for table `hpd_group`
--

CREATE TABLE IF NOT EXISTS `hpd_group` (
  `hpd_id` int(11) NOT NULL,
  `div_name` varchar(100) NOT NULL,
  `div_code` varchar(100) NOT NULL,
  `div_desc` text NOT NULL,
  `div_loc` varchar(100) NOT NULL,
  `div_created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `hpd_group`
--

INSERT INTO `hpd_group` (`hpd_id`, `div_name`, `div_code`, `div_desc`, `div_loc`, `div_created`) VALUES
(1, 'Division head', 'DH', 'Center Head of Home Product Development', '5F RCB', '2016-06-30 10:49:55'),
(2, 'HOME Solutions and Products Design', 'HSPD', 'Solutions and Products design', '5F RCB', '2016-06-30 10:49:55'),
(3, 'HOME Application Development', 'HAM', 'Application Development', '3F RCB', '2016-06-30 10:49:55'),
(4, 'HOME Service Capability Development', 'HSCD', 'Service Capability Dev', '3F RCB', '2016-06-30 10:49:55'),
(5, 'HOME Product and Services Quality Management', 'HSQM', 'Product and services quality Mgmt', '5F RCB', '2016-06-30 10:49:55');
...
INSERT INTO `users` (`user_id`, `users_group_id`, `hpd_id`, `fname`, `mname`, `lname`, `photo`, `email`, `culture`, `password`, `active`, `skin`) VALUES
(3, 1, '2', 'Justin', 'C', 'Castillio', '', 'justin@gmail.com', 'en', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 1, 'blue'),
(4, 4, '1', 'Jose Arnilo', 'S', 'Castaneda', '', 'jscastaneda@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(5, 4, '1', 'Rosemabelle', 'C', 'Jose', '', 'rcjose@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(6, 3, '2', 'Jennette', 'F', 'Herna', '', 'jfherna@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(7, 3, '2', 'Esther', 'R', 'Santos', '', 'ersantos@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(8, 3, '2', 'Galo Emillio', 'C', 'Sanchez', '', 'gcsanchez@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(9, 3, '2', 'Gunther Basil', 'S', 'Guia', '', 'gsguia@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(10, 3, '2', 'Jess Thony', 'D', 'Antolin', '', 'jdantolin@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(11, 3, '2', 'Tanya', 'A', 'Garbiles', '', 'tagarbiles@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(12, 3, '2', 'Craiselle', 'P', 'Cena', '', 't-cpcena@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(13, 3, '2', 'Reniel', 'B', 'Enriquez', '', 't-rbenriquez@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(14, 3, '2', 'Jerwin', 'R', 'Lacsinto', '', 't-jrlacsinto@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(15, 4, '3', 'Daniel', 'L', 'Pis-an', '', 'dlpis-an@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(16, 3, '3', 'Kristine Joy', 'G', 'Pe Benito', '', 'kgpebenito@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(17, 3, '3', 'Albert', 'C', 'Tumaneng', '', 'actumaneng@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(18, 3, '3', 'Bill Bryle', 'C', 'Agravante', '', 'bcargravante@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(19, 3, '3', 'Rudy', 'D', 'Del Carmen', '', 'rddelcarmen@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(20, 3, '3', 'Riezl Anne', 'Q', 'Vergara', '', 't-rqvergara@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(21, 4, '4', 'Nilo', 'L', 'Alcantara', '', 'nlalcantara@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(22, 3, '4', 'Sharon Rose', 'O', 'Magallanes', '', 'somagallanes@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(23, 3, '4', 'Larrel', 'S', 'Quizon', '', 'lsquizon@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(24, 3, '4', 'Gian Carlo', 'D', 'Losa', '', 'gdlosa@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(25, 3, '4', 'Gilbert', 'P', 'Alejandro', '', 'gpalejandro@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(26, 3, '4', 'Michael', 'B', 'Sumanga', '', 'mbsumanga@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(27, 3, '4', 'Kenzie Marie', 'C', 'Lim', '', 't-kclim@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(28, 3, '5', 'Rodel', 'D', 'Kalalang', '', 'rdkalalang@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(29, 3, '5', 'Jeremy', 'B', 'Cheng', '', 'jbcheng@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(30, 3, '5', 'Aivy Miselle', 'M', 'Asis', '', 'amasis@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(31, 3, '5', 'Alexander', 'G', 'Balignasay', '', 'agbalignasay@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(32, 3, '5', 'Rommiel John', 'T', 'Francisco', '', 't-rtfrancisco@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(33, 3, '5', 'Ronald Juancho', 'P', 'Villamor', '', 't-rvillamor@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue'),
(34, 3, '5', 'Delamee Carl', 'A', 'Lumajang', '', 't-dalumajang@pldt.com.ph', 'en', 'c845622f874ee164051d76c9d07c8d53273b8923', 1, 'blue');
...
--
-- Indexes for table `hpd_group`
--
ALTER TABLE `hpd_group`
...
ALTER TABLE `extra_fields_list`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `hpd_group`
--
ALTER TABLE `hpd_group`
...
--
ALTER TABLE `departments`
  ADD CONSTRAINT `fk_departments_users` FOREIGN KEY (`users_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `discussions`
  ...
  ADD CONSTRAINT `discussions_ibfk_2` FOREIGN KEY (`users_id`) REFERENCES `users` (`user_id`) ON DELETE SET NULL ON UPDATE SET NULL,
...
ALTER TABLE `discussions_comments`
  ...
  ADD CONSTRAINT `discussions_comments_ibfk_2` FOREIGN KEY (`users_id`) REFERENCES `users` (`user_id`) ON DELETE SET NULL ON UPDATE SET NULL,
...
--
ALTER TABLE `discussions_reports`
  ADD CONSTRAINT `discussions_reports_ibfk_1` FOREIGN KEY (`users_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `events`
--
ALTER TABLE `events`
  ADD CONSTRAINT `events_ibfk_1` FOREIGN KEY (`users_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `projects`
  ...
  ADD CONSTRAINT `projects_ibfk_3` FOREIGN KEY (`created_by`) REFERENCES `users` (`user_id`) ON DELETE SET NULL ON UPDATE SET NULL;
...
ALTER TABLE `projects_comments`
  ...
  ADD CONSTRAINT `projects_comments_ibfk_2` FOREIGN KEY (`created_by`) REFERENCES `users` (`user_id`) ON DELETE SET NULL ON UPDATE SET NULL;
...
--
ALTER TABLE `projects_reports`
  ADD CONSTRAINT `projects_reports_ibfk_1` FOREIGN KEY (`users_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `tasks`
  ...
  ADD CONSTRAINT `tasks_ibfk_9` FOREIGN KEY (`created_by`) REFERENCES `users` (`user_id`) ON DELETE SET NULL ON UPDATE SET NULL;
...
ALTER TABLE `tasks_comments`
  ...
  ADD CONSTRAINT `tasks_comments_ibfk_2` FOREIGN KEY (`created_by`) REFERENCES `users` (`user_id`) ON DELETE SET NULL ON UPDATE SET NULL,
...
ALTER TABLE `tickets`
  ...
  ADD CONSTRAINT `fk_tickets_users` FOREIGN KEY (`users_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `tickets_comments`
  ...
  ADD CONSTRAINT `fk_tickets_comments_users` FOREIGN KEY (`users_id`) REFERENCES `users` (`user_id`) ON DELETE SET NULL ON UPDATE SET NULL,
...
--
ALTER TABLE `tickets_reports`
  ADD CONSTRAINT `tickets_reports_ibfk_1` FOREIGN KEY (`users_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `user_reports`
  ADD CONSTRAINT `user_reports_ibfk_1` FOREIGN KEY (`users_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
